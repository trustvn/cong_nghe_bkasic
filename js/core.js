...
vnTRUST.popupSite = function(id, title, content, close, opt){
  ...
  ('<div class="classic-popup"'+style+'>')
	  ('<div class="classic-popup-top"><div class="right"><div class="bg-overlay"></div></div></div>')
	  ...
	  ('</div>')
	  ('<div class="classic-popup-bottom"><div class="right"><div class="bg-overlay"></div></div></div>')
  ('</div>')();
};
